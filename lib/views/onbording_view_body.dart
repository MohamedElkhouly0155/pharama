...
import '../views/onbording_content.dart';
import '../models/assets_data.dart';
import '../models/onboard.dart';
import '../widgets/dot_inditcator.dart';
        ...
        actions: [
          TextButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const NormalBottom()),
                );
              },
              child: const Text(
                'Skip',
                  ...
                  onTap: () {
                    if (_pageIndex != onBoardingList.length - 1) {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const NormalBottom()),
                      );
                    }
                  ...
                  child: Ink(
                    ...
                    decoration: const BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: AssetImage("assets/logos/nextbutton.png"),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
